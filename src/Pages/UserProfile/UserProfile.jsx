    ...
    <div className="flex justify-center">
      <div className="px-7 py-16 mb-16 flex flex-col items-center rounded-3xl border-2 drop-shadow-xl border-green-700 bg-green-50">
        ...
        <img
          ...
          className="h-40 w-40 rounded-full border-8 border-green-700 border-spacing-5"
        />
        <form className="mt-6">
          ...
          <div className="flex gap-5 justify-center">
            <button className="btn glass bg-green-700 text-white rounded-xl font-light text-lg flex ">
